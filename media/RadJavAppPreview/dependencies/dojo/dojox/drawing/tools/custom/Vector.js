//>>built
define("dojox/drawing/tools/custom/Vector",["dojo","../../util/oo","../../manager/_registry","../Arrow","../../defaults"],function(_1,oo,_2,_3,_4){
...
var _12=this.util.angle(obj);
_12=_12<0?360+_12:_12;
...
var _14=this.util.angle(obj);
_14=_14<0?360+_14:_14;
...
if(_4.zAxisEnabled){
_5.setup.secondary={name:"vectorSecondary",label:"z-axis",funct:function(_16){
_16.selected?this.zDeselect(_16):this.zSelect(_16);
var _17=this.drawing.stencils.selectedStencils;
for(var nm in _17){
if(_17[nm].shortType=="vector"&&(_17[nm].style.zAxis!=_4.zAxis)){
var s=_17[nm];
s.changeAxis();
if(s.style.zAxis){
s.deselect();
...
_4.zAxisEnabled=true;
});
_1.connect(btn,"disable",function(){
_4.zAxisEnabled=false;
});
}};
}
