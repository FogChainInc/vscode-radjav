//>>built
define("dojox/date/persian/locale",["dojox/main","dojo/_base/lang","dojo/_base/array","dojo/date","dojo/i18n","dojo/regexp","dojo/string","./Date","dojo/i18n!dojo/cldr/nls/persian"],function(_1,_2,_3,dd,_4,_5,_6,_7,_8){
var _9=_2.getObject("date.persian.locale",true,_1);
...
break;
default:
throw new Error("dojox.date.persian.locale.formatPattern: invalid pattern char: "+_f);
}
if(pad){
s=_6.pad(s,l);
}
...
var _1a=_9._getPersianBundle(_18);
var str=[];
...
var _24=_9._getPersianBundle(_23);
...
_9._getPersianBundle=function(_4f){
var _50={};
...
_9.addCustomFormats("dojo.cldr","persian");
_9.getNames=function(_53,_54,_55,_56,_57){
var _58;
var _59=_9._getPersianBundle(_56);
var _5a=[_53,_55,_54];
if(_55=="standAlone"){
var key=_5a.join("-");
_58=_59[key];
