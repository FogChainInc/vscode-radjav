//>>built
define("dojox/widget/Iterator",["dojo","dijit","dojox","dojo/require!dijit/Declaration"],function(_1,_2,_3){
_1.provide("dojox.widget.Iterator");
_1.require("dijit.Declaration");
...
var wc=this.widgetCtor=_1.getObject(this.widgetClass);
this.attrs=_1.map(wc.prototype.templateString.match(/\$\{([^\s\:\}]+)(?:\:([^\s\:\}]+))?\}/g),function(s){
return s.slice(2,-1);
});
_1.forEach(this.attrs,function(m){
wc.prototype[m]="";
});
this.update();
},clear:function(){
...
_1.forEach(this.children,"item.destroy();");
this.children=[];
},update:function(){
if(this.store){
this.fetch();
...
_1.place(_7.domNode,this._srcParent,this._srcIndex+_6);
},getAttrValuesObj:function(_8){
var _9={};
if(_1.isString(_8)){
_1.forEach(this.attrs,function(_a){
_9[_a]=(_a=="value")?_8:this.defaultValue;
},this);
}else{
_1.forEach(this.attrs,function(_b){
if(this.store){
...
this.clear();
_1.forEach(_c,function(_d,_e){
this._addItem(this.getAttrValuesObj(_d),_e);
},this);
},fetch:function(_f,_10,end){
this.store.fetch({query:_f||this.query,start:_10||this.start,count:end||this.fetchMax,onComplete:_1.hitch(this,"onDataAvailable")});
}});
